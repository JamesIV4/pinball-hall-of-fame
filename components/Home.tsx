    ...
    <>
      ...
      <div className="bg-gradient-to-br from-gray-800 to-gray-900 p-6 rounded-lg shadow-lg text-center border border-gray-700">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
          <div className="p-4 bg-gradient-to-br from-gray-700 to-gray-800 rounded-lg border border-gray-600 hover:border-amber-500/50 transition-colors">
        ...
        {stats.highestScore > 0 && (
          <div className="bg-gradient-to-r from-amber-500/10 to-yellow-500/10 border border-amber-500/30 rounded-lg p-4 mb-4">
